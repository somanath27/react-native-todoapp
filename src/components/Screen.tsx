...
import {
  ...
  KeyboardAvoidingViewProps as KeyboardAvoidingViewPropsType,
  LayoutChangeEvent,
  Platform,
  ScrollView,
  ScrollViewProps as ScrollViewPropsType,
  StyleProp,
  View,
  ViewStyle,
  StatusBar,
  StatusBarProps as StatusBarPropsType,
} from 'react-native';
...
interface BaseScreenProps {
   ...
   */
  StatusBarProps?: StatusBarPropsType;
  /**
   * Pass any additional props directly to the KeyboardAvoidingView component.
   */
  KeyboardAvoidingViewProps?: KeyboardAvoidingViewPropsType;
}
...
interface ScrollScreenProps extends BaseScreenProps {
   ...
   */
  ScrollViewProps?: ScrollViewPropsType;
}
